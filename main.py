...
from app.routers import auth, admin, team_member, depot, vehicle, job, optimization, route, bulk_upload, user_mapping, schedule, onboarding, dashboard, route_operations, driver, route_sharing
...
# Route sharing: REST endpoints under /api, WebSocket endpoints at root
app.include_router(route_sharing.router, prefix="/api", tags=["Route Sharing"])
app.include_router(route_sharing.router, tags=["Route Sharing WebSocket"])
